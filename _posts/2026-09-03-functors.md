...
module type Set = sig
  ...
  *)
  ...
  (* LAW: for all (v : Item.t) (w : Item.t) and (set : t),
           (Item.eq v w) => (member set v) = (member set w)
  *)
